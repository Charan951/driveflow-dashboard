...
class _ForgotPasswordPageState extends State<ForgotPasswordPage>
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (ok) {
        setState(() {
          _successMessage = 'If an account exists, a reset OTP has been sent.';
        });
        ...
        setState(() {
          _error = auth.lastError ?? 'Failed to send reset OTP';
        });
      }
    } catch (e) {
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Forgot Password',
                                    key: const Key('forgot_password_title'),
