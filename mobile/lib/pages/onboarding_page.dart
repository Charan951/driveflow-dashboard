...
const _slides = [
  _OnboardingSlide(
    title: 'Your Vehicle,\nOur Care',
    body: 'Manage your vehicle servicing conveniently from one place.',
    accent: AppColors.primaryBlue,
    glow: AppColors.primaryBlueSoft,
    imageAsset: 'assets/onboarding_care.png',
  ),
  _OnboardingSlide(
    title: 'Book in\nMinutes',
    body:
        'Wash, tyres, battery and periodic service — schedule from the app and we’ll take it from there.',
    accent: AppColors.cinematicOrange,
    glow: Color(0xFFFF8A3D),
    imageAsset: 'assets/onboarding_workshop.png',
  ),
  _OnboardingSlide(
    title: 'Stay Updated',
    body:
        'Track your vehicle, monitor service progress, and approve replacement parts.',
    accent: AppColors.primaryPurple,
    glow: Color(0xFFA78BFA),
    imageAsset: 'assets/onboarding_tracking.png',
  ),
];
