            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-muted-foreground mb-6 text-xl leading-relaxed">
                  At Carzzi, we’re redefining how vehicle owners experience car
                  care. Built for convenience, transparency, and control, Carzzi
                  is a tech-driven mobility platform designed to eliminate the
                  chaos and uncertainty that comes with traditional car
                  servicing.
                </p>
                <p className="text-muted-foreground text-xl leading-relaxed">
                  Carzzi is owned and operated by{" "}
                  <span className="font-bold text-foreground">
                    Hyper Mobility Services
                  </span>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              Carzzi is your one-stop solution for everything your car needs —
              from servicing and maintenance to emergency support — all managed
              effortlessly through a single app.
            </p>
          </motion.div>
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              We stand out from the crowd with our unwavering commitment to
              excellence.
            </p>
          </motion.div>
          ...
          >
            {whyChoose.map((feature, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg mx-auto group-hover:scale-110 transition-transform duration-300`}
                >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-xl leading-relaxed">
                  To become Hyderabad’s most trusted and intelligent car care
                  platform, delivering a complete ecosystem where vehicle owners
                  can manage every aspect of their car effortlessly.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-xl leading-relaxed">
                  To simplify car ownership by creating a single, reliable
                  platform that handles everything — so you never have to worry
