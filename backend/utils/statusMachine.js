...
const CANON_TRANSITIONS = {
  ...
  VEHICLE_AT_MERCHANT: ['JOB_CARD', 'SERVICE_STARTED', 'CANCELLED'],
  JOB_CARD: ['SERVICE_STARTED', 'CANCELLED'],
...
export const v2FromCanon = (canon) => {
  ...
  const v2 = entries.find(([k, v]) => v === canon && ['REQUESTED','ASSIGNED','ACCEPTED','ON_THE_WAY_TO_CUSTOMER','NEAR_CUSTOMER','REACHED_PICKUP','VEHICLE_PICKED_UP','AT_SERVICE_CENTER','IN_SERVICE','SERVICE_COMPLETED','RETURNING_TO_CUSTOMER','DELIVERED','COMPLETED'].includes(k));
