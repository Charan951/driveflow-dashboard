...
const vehicleSchema = new mongoose.Schema({
  ...
  frontTyres: { type: String, maxlength: 100 },
  rearTyres: { type: String, maxlength: 100 },
  batteryDetails: { type: String, maxlength: 100 },
  pickupDropPrice: { type: String, maxlength: 20 },
